...
public class FuzzyQuery extends MultiTermQuery {
  ...
  private final int maxEdits;  // 编辑距离的最大编辑值
  private final int maxExpansions;  //在maxEdits和prefixLength条件下，可能匹配到多个term，但是只允许处理多少个term
  private final boolean transpositions;
  private final int prefixLength;  // 模糊匹配到的term至少跟查询值term有多少个相同的前缀值

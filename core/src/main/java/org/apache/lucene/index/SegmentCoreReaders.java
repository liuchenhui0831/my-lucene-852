...
final class SegmentCoreReaders {
  ...
  final FieldsProducer fields; //从索引文件tim,tip，doc,pos,pay中读取域的索引信息
  final NormsProducer normsProducer; //从nvd,nvm中读取域的打分信息

  final StoredFieldsReader fieldsReaderOrig; //从fdt,fdx中读取存储域的索引信息
  final TermVectorsReader termVectorsReaderOrig; //从tvx,tvd读取词向量的索引信息
  final PointsReader pointsReader; //从dim,dii中读取域值为数值类型的索引信息
  final Directory cfsReader;
  final String segment; //段的前缀名
  /** 
  ...
  final FieldInfos coreFieldInfos;  //从fnm中读取域的信息
